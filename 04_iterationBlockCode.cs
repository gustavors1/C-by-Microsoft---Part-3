...
/*
La instrucción for es importante porque permite recorrer en iteración el bloque de código 100 veces.
if-elseif-else permite buscar los divisores de 3 y 5.
%, el operador mod, permite determinar si 3 o 5 se dividen por otro número sin un resto.
Asimismo, el operador && garantiza que se puede dividir un número en 3 y 5 para la condición FizzBuzz.
*/